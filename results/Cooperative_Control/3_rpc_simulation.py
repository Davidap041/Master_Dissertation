...
plt.grid()
plt.savefig('fig/case3_fig3.png', bbox_inches='tight')
...
def force_function(t):
    ...
    F[t < 30] = 0.5  # Force is 1.5 for t < 5
...
plt.ylabel('Position')
plt.legend()
plt.savefig('fig/case3_fig1.png', bbox_inches='tight')
...
plt.plot(t_forced, v2, label='Agent B (Velocity)', linestyle='-.', color='magenta')

# plt.plot(t_forced, x3, label='Leader (Position)')
plt.plot(t_forced, v3, label='Leader (Reference)', linestyle='-.', color='red')
...
plt.grid()
plt.savefig('fig/case3_fg2.png', bbox_inches='tight')
#plt.show()
